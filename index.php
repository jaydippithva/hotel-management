...
<body class="bg-light">
          ...
          <div class="row align-items-end">
            ...
            <div class="col-lg-3 mb-3">
              ...
              <select class="form-select shadow-none" name="adult">
                <?php
                $guests_q = mysqli_query($con, "SELECT MAX(adult) AS `max_adult`,MAX(children) AS `max_children` FROM `rooms` WHERE `status`='1' AND `remove`='0'");
    ...
    <div class="row">
      ...
      while ($room_data = mysqli_fetch_assoc($room_res)) {
        ...
        while ($fea_row = mysqli_fetch_assoc($fea_q)) {
          $features_data .= "  <span class='badge bg-light text-dark text-wrap me-1 mb-1'> $fea_row[name]  </span>";
        }
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      ?>
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Fecilities >>></a>
      </div>
    </div>
  </div>
            ...
            echo <<<slides
                    <div class="swiper-slide bg-white p-4">
                        <div class="profile d-flex align-items-center mb-3">
                          ...
                          <h6 class="m-2 ms-2">$row[uname]</h6>
                        </div>
                        <p>
                          $row[review]
                        </p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
        <iframe class="w-100 rounded" height="320px" src="<?php echo $contact_r['iframe'] ?>" width="600" loading="lazy"></iframe>
      </div>
      ...
      <div class="modal-content">
        <form id="recovery-form">
          ...
          <div class="modal-body">
            ...
            <div class="d-flex">
              <div class="col-lg-12">
                <div class="align-items-center  mb-2 mt-2 d-flex text-end">
    ...
    recovery_form.addEventListener('submit', (e) => {
      ...
      xhr.onload = function() {
        if (this.responseText == 'failed') {
          ...
          alert('success', "ACCOUNT RESET SECCESSFUL!!");
          recovery_form.reset();
