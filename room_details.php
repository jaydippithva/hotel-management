  ...
  <div class="container">
    <div class="row">
      <div class="col-12 my-5 mb-4 px-4">
        <h2 class="fw-font"><?php echo $room_data['name'] ?></h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration">HOME</a>
          <span class="text-secondary">></span>
          <a href="rooms.php" class="text-secondary text-decoration">ROOMS</a>
          ...
          <div class="card-body">
            ...
            echo <<<area
                  <div class=" mb-3">
                    ...
                    <span class='badge bg-light text-dark text-wrap me-1 mb-1'> $room_data[area] sq.ft.  </span>
            ...
            if (!$settings_r['shutdown']) {
              ...
              echo <<<book
                  <button  onclick='checklogintobook($login,$room_data[id])' class="btn text-white custom-bg shadow-none mb-1  w-100">Book Now</button>
              book;
            }
