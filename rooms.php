...
<body class="bg-light">
  ...
  <div class="container-fluid ">
    <div class="row">
      <div class="col-lg-3 col-md-12 mb-4 mb-lg-0 ps-4">
        <nav class="navbar navbar-expand-lg navbar-light bg-white rouunded shadow">
          <div class="container-fluid flex-lg-column align-items-stretch">
            <h4 class="mt-2">FILTERS</h4>
            <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#filterdropdwon" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="filterdropdwon">
              <!-- check availibility -->
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3 d-flex align-items-ceter justify-content-between " style="font-size:18px;">
                  <span>CHECK AVAILIBILITY</span>
                  <button id="chk_avail_btn" onclick="chk_avail_clear()" class="btn shdow-none btn-sm text-secondary d-none">Reset</button>
                </h5>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3 d-flex align-items-ceter justify-content-between " style="font-size:18px;">
                  ...
                  <button id="facilities_btn" onclick="facilities_clear()" class="btn shdow-none btn-sm text-secondary d-none">Reset</button>
                </h5>
                <?php
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3 d-flex align-items-ceter justify-content-between " style="font-size:18px;">
                  <span>GUEST</span>
                  <button id="guests_btn" onclick="guests_clear()" class="btn shdow-none btn-sm text-secondary d-none">Reset</button>
                </h5>
                <div class="d-flex">
                  <div class="me-3">
  ...
  <script>
    ...
    chk_avail_btn = document.getElementById('chk_avail_btn');
