  ...
  <div class="container">
    <div class="row">
      <div class="col-12 my-5  px-4">
        <h2 class="fw-font">Profile</h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration">HOME</a>
          <span class="text-secondary">></span>
          <a href="#" class="text-secondary text-decoration">PROFILE</a>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-5  px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            ...
            <input type="file" name="profile" accept=".jpg,.png,.jpeg,.webp" class="form-control shadow-none mb-4" required>
