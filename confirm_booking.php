...
<head>
  ...
  <title> <?php echo $settings_r['site_title'] ?>confirm bookings</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 my-5 mb-4 px-4">
        <h2 class="fw-font">confirm booking</h2>
        <div style="font-size: 14px;">
          ...
          <span class="text-secondary">></span>
          <a href="#" class="text-secondary text-decoration">Confirm</a>
            ...
            <form action="pay_now.php" method="POST" id="booking_form">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <button name="pay_now" class="btn w-100 text-white custom-bg mb-1 shadow-none  " disabled>Pay Now</button>
                </div>
              </div>
            </form>
